...
import './Projects.css';
import { FaReact, FaNodeJs, FaDatabase, FaMobileAlt, FaGamepad, FaFileAlt, FaLaptopCode, FaServer, FaChevronDown, FaChevronUp } from 'react-icons/fa';
                ...
                {projects.map((project, index) => (
                    <div key={index} className={`project-card ${expandedProject === index ? 'expanded' : ''}`}>
                        <div className="project-header">
                            ...
                            <button className="toggle-button" onClick={() => toggleProjectDetails(index)}>
